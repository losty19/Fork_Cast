// Auto-generated from ingredients.csv
export interface Ingredient {
  id: number;
  name: string;
}
// The top 1,000 most common ingredients
// "Name": ID_number,
export const commonIngredients: Record<string, number> = {
...
export const ingredientsList: Ingredient[] = Object.entries(commonIngredients).map(
  ([name, id]) => ({ name, id })
);
...
export const ingredientUtils = {
  getIngredientId(name: string): number | undefined {
    ...
    return commonIngredients[normalizedName];
  },
